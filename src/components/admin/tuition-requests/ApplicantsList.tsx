        ...
        {applicants.map((application) => (
          <div
            ...
            className={`border rounded-lg p-4 flex flex-col gap-2 ${
              application.isNew ? "border-primary-container bg-primary-container/5" : "border-surface-variant"
            }`}
          >
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-start gap-2">
                {application.isNew && <span className="w-2 h-2 rounded-full bg-primary-container mt-1.5 shrink-0" />}
                <div>
                  <p
                    className={`font-label-md text-label-md ${
                      application.isNew ? "text-on-surface font-bold" : "text-on-surface-variant"
                    }`}
                  >
